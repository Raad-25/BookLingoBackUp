...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3 my-4", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center mt-0.5 flex-shrink-0">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
             ...
             {isUser && (
                <div className="h-8 w-8 rounded-full bg-slate-700 text-white flex items-center justify-center mt-0.5 flex-shrink-0">
